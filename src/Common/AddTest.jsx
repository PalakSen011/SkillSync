...
import add_new_green from "../assets/add-green.png";
import dropDown from "../assets/darkdropdown.svg";
import dropUp from "../assets/darkdropup.svg";
        ...
        <div className="w-full border mt-6 p-4 border-neutral-300">
          <div className="flex gap-3">
            ...
            <div className="flex w-1/3 flex-col relative">
              ...
              <img
                src={isOpen ? dropUp : dropDown} // Switch icon based on state
                alt="dropdown"
          ...
          <div className="mt-4 flex gap-4 justify-end">
            <img src={copyIcon} alt="copy icon" className="h-8" />
            <img src={trash} alt="copy icon" className="h-6" />
          </div>
        </div>
        <div className="mt-4 flex gap-1  ">
          <img src={add_new_green} alt="add new icon" className=" h-6" />
